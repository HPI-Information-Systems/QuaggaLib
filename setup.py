...
setup(
	...
	install_requires=['absl-py==0.3.0', 'astor==0.7.1', 'autopep8==1.3.5', 'bleach==1.5.0', 'click==6.7',
	                  ...
	                  'kiwisolver==1.0.1', 'Markdown==2.6.11', 'MarkupSafe==1.0', 'matplotlib==2.2.2', 'numpy==1.15.1', 'nose==1.3.7',
	...
	dependency_links=['git+https://www.github.com/keras-team/keras-contrib.git@f25c26665e990cfdf1da61a3de10a34d67f74b37#egg=keras-contrib', 'git+https://github.com/scrapinghub/dateparser.git@a01a4d2071a8f1d4b368543e5e09cde5eb880799#egg=dateparser'],
)
