...
setup(
	...
	install_requires=['absl-py==0.3.0', 'astor==0.7.1', 'bleach==1.5.0', 'click==6.7',
	                  'cycler==0.10.0', 'dateparser@git+https://github.com/scrapinghub/dateparser.git@a01a4d2071a8f1d4b368543e5e09cde5eb880799#egg=dateparser', 'Flask==1.0.2', 'gast==0.2.0', 'grpcio==1.14.0', 'h5py==2.8.0',
	                  ...
	                  'Werkzeug==0.14.1', 'keras-contrib@git+https://www.github.com/keras-team/keras-contrib.git@f25c26665e990cfdf1da61a3de10a34d67f74b37#egg=keras-contrib-0'],
)
