...
class TestDenotationBlockConverter(TestCase):
	...
	def test_convert(self):
		...
		expected = {'blocks': [{'from': None, 'raw_from': None, 'raw_xfrom': None, 'to': None, 'raw_to': None, 'raw_xto': None, 'cc': None, 'raw_cc': None, 'raw_xcc': None, 'sent': None, 'raw_sent': None, 'subject': None, 'raw_subject': None, 'type': 'root', 'raw_header': [], 'text': ["That's it.  Thanks to plove I am no longer entering my own deals.", '', '', '', '', '']}, {'from': 'Phillip M Love', 'raw_from': 'Phillip M Love', 'raw_xfrom': 'Phillip M Love', 'to': ['Eric Bass'], 'raw_to': ['Eric Bass'], 'raw_xto': ['Eric Bass'], 'cc': [], 'raw_cc': [], 'raw_xcc': [], 'sent': ' 03/26/2001 10:20 AM', 'raw_sent': ' 03/26/2001 10:20 AM', 'subject': 'Re:', 'raw_subject': 'Re:', 'type': 'reply', 'raw_header': 'Phillip M Love\n03/26/2001 10:20 AM\nTo:\tEric Bass/HOU/ECT@ECT\ncc:\t \nSubject:\tRe:   \n', 'text': ['', 'We can always count on you to at least give us one on the error report.', 'PL', '', '', '', '', '', '<Embedded StdOleLink>']}]}
